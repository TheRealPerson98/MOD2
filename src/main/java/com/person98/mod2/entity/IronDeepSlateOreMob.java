...
public class IronDeepSlateOreMob extends PathAwareEntity implements OreMob {
    ...
    public void tick() {
        ...
        if (this.shouldTransformBack && this.age >= 100) {  // Check age for 5 seconds
            ...
            this.getWorld().setBlockState(this.getBlockPos(), Blocks.DEEPSLATE_IRON_ORE.getDefaultState());
