...
public class EmeraldOreMob extends PathAwareEntity implements OreMob {
    private boolean shouldTransformBack = false;

    public EmeraldOreMob(EntityType<? extends PathAwareEntity> entityType, World world) {
    ...
    public void tick() {
        ...
        if (this.shouldTransformBack && this.age >= 100) {  // Check age for 5 seconds
            ...
            this.getWorld().setBlockState(this.getBlockPos(), Blocks.EMERALD_ORE.getDefaultState());
